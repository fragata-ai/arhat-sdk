...
Performs element-wise greater than comparison **>** with broadcast support
...
```
func(f *Fragment) Gt(args ...interface{}) front.Layer
```
...
func Gt(g api.Graph, t core.Type, aShape []int, bShape []int) {
    a := g.NewTensor(t)
    b := g.NewTensor(t)
    c := g.NewTensor(core.TypeBool)
    g.External(a, aShape)
    g.External(b, bShape)
    g.GtOp(a, b, c, false, -1)
    g.Return(c)
}
```
...
func Gt(m *models.Model, t string, aShape []int, bShape []int) {
